...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Best PNG Compressor Online 2025 | Free PNG Image Compression Tool</title>
        <meta name="description" content="🏆 #1 Free Online PNG Compressor - Reduce PNG file size by up to 80% without losing quality. Instant compression, batch processing, transparency support. No signup needed. 100% secure browser-based compression tool." />
        <meta name="keywords" content="png compressor, compress png, png compression tool, reduce png size, best png compressor 2025, free png optimizer" />
        <link rel="canonical" href="https://compresspng.xyz/" />
      </Helmet>
